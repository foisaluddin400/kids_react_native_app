...
export default function Details() {
  ...
  const article = {
    id,
    thumbnail: { uri: `https://via.placeholder.com/600x300.png?text=Article+${id}` },
    title: 'React Native Advanced Guide',
    description:
      'This is a detailed article about React Native. Learn navigation, performance optimization, state management, and more advanced concepts for real-world app development.',
    date: '2026-02-20',
  };
